    ...
    let updatePayPalButtonStyling = function (location, buttonType, buttonShow, buttonLabel, buttonColor, buttonShape, buttonSize) {
        ...
        if (currentButtonElement.length) {
            ...
            if (!button.isEligible()) {
                console.log(buttonType.charAt(0).toUpperCase() + buttonType.slice(1).toLowerCase() + ' button is not eligible');
                if (currentButtonElement.length && currentButtonId.startsWith(buttonType)) {
